...
public class QUserStats extends EntityPathBase<UserStats> {
    ...
    private static final long serialVersionUID = -1306658671L;
    ...
    public final ListPath<CharacterStats, QCharacterStats> characterStatsList = this.<CharacterStats, QCharacterStats>createList("characterStatsList", CharacterStats.class, QCharacterStats.class, PathInits.DIRECT2);
