...
/**
 * QItemWeapon is a Querydsl query type for ItemWeapon
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QItemWeapon extends EntityPathBase<ItemWeapon> {

    private static final long serialVersionUID = 773591985L;

    public static final QItemWeapon itemWeapon = new QItemWeapon("itemWeapon");
    ...
    public final BooleanPath consumable = createBoolean("consumable");
    ...
    public final StringPath gradeBgOverride = createString("gradeBgOverride");
    ...
    public final BooleanPath notDisarm = createBoolean("notDisarm");
    ...
    public final StringPath weaponType = createString("weaponType");

    public QItemWeapon(String variable) {
        super(ItemWeapon.class, forVariable(variable));
    }

    public QItemWeapon(Path<? extends ItemWeapon> path) {
        super(path.getType(), path.getMetadata());
    }

    public QItemWeapon(PathMetadata metadata) {
        super(ItemWeapon.class, metadata);
    }
